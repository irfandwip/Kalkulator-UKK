...
#btn 1 to 3
btn1 = Button(frame1,text="1",width=9,height=3, bg="#795A70",command=lambda:addToText("1"))
btn1.pack(side=LEFT)
btn2 = Button(frame1,text="2",width=9,height=3,bg="#795A70",command=lambda:addToText("2"))
btn2.pack(side=LEFT)
btn3 = Button(frame1,text="3",width=9,height=3, bg="#795A70",command=lambda:addToText("3"))
btn3.pack(side=LEFT)
...
#btn 4 to 6
btn4 = Button(frame2,text="4",width=9,height=3, bg="#795A70",command=lambda:addToText("4"))
btn4.pack(side=LEFT)
btn5 = Button(frame2,text="5",width=9,height=3, bg="#795A70",command=lambda:addToText("5"))
btn5.pack(side=LEFT)
btn6 = Button(frame2,text="6",width=9,height=3, bg="#795A70",command=lambda:addToText("6"))
btn6.pack(side=LEFT)
...
#btn 7 to 9
btn7 = Button(frame3,text="7",width=9,height=3,bg="#795A70", command=lambda:addToText("7"))
btn7.pack(side=LEFT)
btn8 = Button(frame3,text="8",width=9,height=3, bg="#795A70",command=lambda:addToText("8"))
btn8.pack(side=LEFT)
btn9 = Button(frame3,text="9",width=9,height=3,bg="#795A70", command=lambda:addToText("9"))
btn9.pack(side=LEFT)
